export function is_in_list() {
    // array of subscription product skus
    ...
    // Search for keyword content meta elements
    let keywords = document.querySelectorAll('meta[name="keyword"][content]')
    // Get the current pdp sku
    let possible_skus = [document.querySelector('.pdp-accordion__content-partNumber').textContent.replace(/P/g, "")]
    // Loop through all keywords and add them to the possible_skus list. This is to account for multi-variant PDPs
    keywords.forEach(kw => {
    ...
    // Return true if there is at least 1 sku on the page in the db variable
